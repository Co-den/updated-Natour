...
exports.getCheckoutSession = catchAsync(async (req, res, next) => {
  ...
  console.log('Creating checkout session for tour:', tour.name);
    ...
    line_items: [
      {
        price_data: {
          ...
          product_data: {
            ...
            images: [
              `${req.protocol}://${req.get('host')}/img/tours/${tour.imageCover}`, // Product image
            ],
          },
          unit_amount: tour.price * 100, // Amount in cents (e.g., $20.00 = 2000)
        },
